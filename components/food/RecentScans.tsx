...
export default function RecentScans() {
  ...
  if (loading) {
    return (
      <div className="rounded-2xl bg-linear-to-r from-emerald-50 to-teal-50 p-6 border border-orange-100">
        <h2 className="font-bold text-orange-900 mb-4">Recent Scans</h2>
        <div className="text-center text-orange-700">Loading...</div>
      </div>
    );
  }
  ...
  if (!analyses || analyses.length === 0) {
    return (
      <div className="rounded-2xl bg-linear-to-r from-emerald-50 to-teal-50 p-6 border border-orange-100">
        <h2 className="font-bold text-orange-900 mb-4">Recent Scans</h2>
        <div className="text-center text-orange-700">No scans yet. Try uploading a food image!</div>
      </div>
    );
  }
