...
import { Apple, Camera, CircleCheck, FilePenLine, Hamburger, Salad, Search } from 'lucide-react';
      ...
      <div className="flex-1 px-4 sm:px-6 py-6 sm:py-8 max-w-4xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-2xl bg-blue-50 p-6 border border-blue-100">
            <h3 className="font-semibold text-blue-900 mb-2 flex gap-1.5"><FilePenLine/> How it works</h3>
          ...
          <div className="rounded-2xl bg-green-50 p-6 border border-green-100">
            <h3 className="font-semibold text-green-900 mb-2 flex gap-1.5"><CircleCheck/> Best practices</h3>
          ...
          <div className="rounded-2xl bg-purple-50 p-6 border border-purple-100">
            <h3 className="font-semibold text-purple-900 mb-2 flex gap-1.5"><Search/> Multiple items</h3>
        ...
        <div className="mt-8 rounded-2xl bg-linear-to-r from-emerald-50 to-teal-50 p-6 border border-emerald-100">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between bg-white rounded-lg p-4">
              <div>
                <p className="font-medium text-gray-900 flex gap-1.5"><Apple color='green'/> Apple</p>
            ...
            <div className="flex items-center justify-between bg-white rounded-lg p-4">
              <div>
                <p className="font-medium text-gray-900 flex gap-1.5"><Hamburger color='brown'/> Cheeseburger</p>
            ...
            <div className="flex items-center justify-between bg-white rounded-lg p-4">
              <div>
                <p className="font-medium text-gray-900 flex gap-1.5"><Salad color='green'/> Salad</p>
